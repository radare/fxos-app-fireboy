...
function gb_PressKey(k) {
switch (k) {
case "down":gbPin14&=0xF7; MEMW(_IF_,gbRegIF|16); break;
case "up": gbPin14&=0xFB; MEMW(_IF_,gbRegIF|16); break;
case "left": gbPin14&=0xFD; MEMW(_IF_,gbRegIF|16); break;
case "right": gbPin14&=0xFE; MEMW(_IF_,gbRegIF|16); break;
case "start": gbPin15&=0xF7; MEMW(_IF_,gbRegIF|16); break;
case "select": gbPin15&=0xFB; MEMW(_IF_,gbRegIF|16); break;
case "b": gbPin15&=0xFD; MEMW(_IF_,gbRegIF|16); break;
case "a": gbPin15&=0xFE; MEMW(_IF_,gbRegIF|16); break;
}
}
function gb_ReleaseKey(k) {
  switch (k) {
    case "down": gbPin14|=8; MEMW(_IF_,gbRegIF|16); return;
    case "up": gbPin14|=4; MEMW(_IF_,gbRegIF|16); return;
    case "left": gbPin14|=2; MEMW(_IF_,gbRegIF|16); return;
    case "right": gbPin14|=1; MEMW(_IF_,gbRegIF|16); return;
    case "start": gbPin15|=8; MEMW(_IF_,gbRegIF|16); return;
    case "select": gbPin15|=4; MEMW(_IF_,gbRegIF|16); return;
    case "b": gbPin15|=2; MEMW(_IF_,gbRegIF|16); return;
    case "a": gbPin15|=1; MEMW(_IF_,gbRegIF|16); return;
  }
}
