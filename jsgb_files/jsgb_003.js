...
OP[0x04]=Function(gb_CPU_INC('RB',4)); // INC B
OP[0x05]=Function(gb_CPU_DEC('RB',4)); // DEC B
...
OP[0x08]=Function(gb_LD_MEM_R16('HL',20)); // LD (u16),SP
...
OP[0x0C]=Function(gb_CPU_INC('RC',4)); // INC C
OP[0x0D]=Function(gb_CPU_DEC('RC',4)); // DEC C
...
OP[0x14]=Function(gb_CPU_INC('RD',4)); // INC D
OP[0x15]=Function(gb_CPU_DEC('RD',4)); // DEC D
OP[0x16]=function(){ RD=MEMR(PC++); gbCPUTicks=8; }; // LD D,u8
OP[0x17]=Function(gb_CPU_RLA()); // RLA
OP[0x18]=Function(gb_CPU_JR('true')); // JR s8
...
OP[0x1C]=Function(gb_CPU_INC('RE',4)); // INC E
OP[0x1D]=Function(gb_CPU_DEC('RE',4)); // DEC E
...
OP[0x20]=Function(gb_CPU_JR('!FZ')); // JR NZ,s8
...
OP[0x24]=Function('T1=HL>>8;'+gb_CPU_INC('T1',4)+'HL=(HL&0x00FF)|(T1<<8);'); // INC H
OP[0x25]=Function('T1=HL>>8;'+gb_CPU_DEC('T1',4)+'HL=(HL&0x00FF)|(T1<<8);'); // DEC H
OP[0x26]=function(){ HL&=0x00FF; HL|=MEMR(PC++)<<8; gbCPUTicks=8; }; // LD H,u8
OP[0x27]=Function(gb_CPU_DDA()); // DAA
OP[0x28]=Function(gb_CPU_JR('FZ')); // JR Z,s8
...
OP[0x2C]=Function('T1=HL&0xFF;'+gb_CPU_INC('T1',4)+'HL=(HL&0xFF00)|T1;'); // INC L
OP[0x2D]=Function('T1=HL&0xFF;'+gb_CPU_DEC('T1',4)+'HL=(HL&0xFF00)|T1;'); // DEC L
OP[0x2E]=function(){ HL&=0xFF00; HL|=MEMR(PC++); gbCPUTicks=8; }; // LD L,u8
OP[0x2F]=function(){ RA^=0xFF; FN=1; FH=1; gbCPUTicks=4; }; // CPL
OP[0x30]=Function(gb_CPU_JR('!FC')); // JR NC,s8
...
OP[0x34]=Function('T1=MEMR(HL);'+gb_CPU_INC('T1',12)+'MEMW(HL,T1);'); // INC (HL)
OP[0x35]=Function('T1=MEMR(HL);'+gb_CPU_DEC('T1',12)+'MEMW(HL,T1);'); // DEC (HL)
OP[0x36]=function(){ MEMW(HL,MEMR(PC++)); gbCPUTicks=12; }; // LD (HL),u8;
OP[0x37]=function(){ FC=1; FN=0; FH=0; gbCPUTicks=4; }; // SCF
OP[0x38]=Function(gb_CPU_JR('FC')); // JR C,s8
...
OP[0x3C]=Function(gb_CPU_INC('RA',4)); // INC A
OP[0x3D]=Function(gb_CPU_DEC('RA',4)); // DEC A
...
OP[0x76]=Function(gb_CPU_HALT()); // HALT
...
OP[0x80]=Function(gb_CPU_ADD_A('RB',4)); // ADD A,B
OP[0x81]=Function(gb_CPU_ADD_A('RC',4)); // ADD A,C
OP[0x82]=Function(gb_CPU_ADD_A('RD',4)); // ADD A,D
OP[0x83]=Function(gb_CPU_ADD_A('RE',4)); // ADD A,E
OP[0x84]=Function('T1=HL>>8;'+gb_CPU_ADD_A('T1',4)); // ADD A,H
OP[0x85]=Function('T1=HL&0xFF;'+gb_CPU_ADD_A('T1',4)); // ADD A,L
OP[0x86]=Function('T1=MEMR(HL);'+gb_CPU_ADD_A('T1',8)); // ADD A,(HL)
OP[0x87]=Function(gb_CPU_ADD_A('RA',4)); // ADD A,A
OP[0x88]=Function(gb_CPU_ADC_A('RB',4)); // ADC A,B
OP[0x89]=Function(gb_CPU_ADC_A('RC',4)); // ADC A,C
OP[0x8A]=Function(gb_CPU_ADC_A('RD',4)); // ADC A,D
OP[0x8B]=Function(gb_CPU_ADC_A('RE',4)); // ADC A,E
OP[0x8C]=Function('T1=HL>>8;'+gb_CPU_ADC_A('T1',4)); // ADC A,H
OP[0x8D]=Function('T1=HL&0xFF;'+gb_CPU_ADC_A('T1',4)); // ADC A,L
OP[0x8E]=Function('T1=MEMR(HL);'+gb_CPU_ADC_A('T1',8)); // ADC A,(HL)
OP[0x8F]=Function(gb_CPU_ADC_A('RA',4)); // ADC A,A
OP[0x90]=Function(gb_CPU_SUB_A('RB',4)); // SUB B
OP[0x91]=Function(gb_CPU_SUB_A('RC',4)); // SUB C
OP[0x92]=Function(gb_CPU_SUB_A('RD',4)); // SUB D
OP[0x93]=Function(gb_CPU_SUB_A('RE',4)); // SUB E
OP[0x94]=Function('T1=HL>>8;'+gb_CPU_SUB_A('T1',4)); // SUB H
OP[0x95]=Function('T1=HL&0xFF;'+gb_CPU_SUB_A('T1',4)); // SUB L
OP[0x96]=Function('T1=MEMR(HL);'+gb_CPU_SUB_A('T1',8)); // SUB (HL)
OP[0x97]=Function(gb_CPU_SUB_A('RA',4)); // SUB A
OP[0x98]=Function(gb_CPU_SBC_A('RB',4)); // SBC A,B
OP[0x99]=Function(gb_CPU_SBC_A('RC',4)); // SBC A,C
OP[0x9A]=Function(gb_CPU_SBC_A('RD',4)); // SBC A,D
OP[0x9B]=Function(gb_CPU_SBC_A('RE',4)); // SBC A,E
OP[0x9C]=Function('T1=HL>>8;'+gb_CPU_SBC_A('T1',4)); // SBC A,H
OP[0x9D]=Function('T1=HL&0xFF;'+gb_CPU_SBC_A('T1',4)); // SBC A,L
OP[0x9E]=Function('T1=MEMR(HL);'+gb_CPU_SBC_A('T1',8)); // SBC A,(HL)
OP[0x9F]=Function(gb_CPU_SBC_A('RA',4)); // SBC A,A
OP[0xA0]=Function(gb_CPU_AND_A('RB',4)); // AND B
OP[0xA1]=Function(gb_CPU_AND_A('RC',4)); // AND C
OP[0xA2]=Function(gb_CPU_AND_A('RD',4)); // AND D
OP[0xA3]=Function(gb_CPU_AND_A('RE',4)); // AND E
OP[0xA4]=Function(gb_CPU_AND_A('HL>>8',4)); // AND H
OP[0xA5]=Function(gb_CPU_AND_A('HL&0xFF',4)); // AND L
OP[0xA6]=Function(gb_CPU_AND_A('MEMR(HL)',8)); // AND (HL)
OP[0xA7]=Function(gb_CPU_AND_A('RA',4)); // AND A
OP[0xA8]=Function(gb_CPU_XOR_A('RB',4)); // XOR B
OP[0xA9]=Function(gb_CPU_XOR_A('RC',4)); // XOR C
OP[0xAA]=Function(gb_CPU_XOR_A('RD',4)); // XOR D
OP[0xAB]=Function(gb_CPU_XOR_A('RE',4)); // XOR E
OP[0xAC]=Function(gb_CPU_XOR_A('HL>>8',4)); // XOR H
OP[0xAD]=Function(gb_CPU_XOR_A('HL&0xFF',4)); // XOR L
OP[0xAE]=Function(gb_CPU_XOR_A('MEMR(HL)',8)); // XOR (HL)
OP[0xAF]=Function(gb_CPU_XOR_A('RA',4)); // XOR A
OP[0xB0]=Function(gb_CPU_OR_A('RB',4)); // OR B
OP[0xB1]=Function(gb_CPU_OR_A('RC',4)); // OR C
OP[0xB2]=Function(gb_CPU_OR_A('RD',4)); // OR D
OP[0xB3]=Function(gb_CPU_OR_A('RE',4)); // OR E
OP[0xB4]=Function(gb_CPU_OR_A('HL>>8',4)); // OR H
OP[0xB5]=Function(gb_CPU_OR_A('HL&0xFF',4)); // OR L
OP[0xB6]=Function(gb_CPU_OR_A('MEMR(HL)',8)); // OR (HL)
OP[0xB7]=Function(gb_CPU_OR_A('RA',4)); // OR A
OP[0xB8]=Function(gb_CPU_CP_A('RB',4)); // CP B
OP[0xB9]=Function(gb_CPU_CP_A('RC',4)); // CP C
OP[0xBA]=Function(gb_CPU_CP_A('RD',4)); // CP D
OP[0xBB]=Function(gb_CPU_CP_A('RE',4)); // CP E
OP[0xBC]=Function('T1=HL>>8;'+gb_CPU_CP_A('T1',4)); // CP H
OP[0xBD]=Function('T1=HL&0xFF;'+gb_CPU_CP_A('T1',4)); // CP L
OP[0xBE]=Function('T1=MEMR(HL);'+gb_CPU_CP_A('T1',8)); // CP (HL)
OP[0xBF]=Function(gb_CPU_CP_A('RA',4)); // CP A
OP[0xC0]=Function(gb_CPU_RET('!FZ')); // RET NZ
OP[0xC1]=function(){ RC=MEMR(SP++); RB=MEMR(SP++); gbCPUTicks=12; }; // POP BC
OP[0xC2]=Function(gb_CPU_JP('!FZ')); // JP NZ,u16
OP[0xC3]=Function(gb_CPU_JP('true')); // JP u16;
OP[0xC4]=Function(gb_CPU_CALL('!FZ')); // CALL NZ,u16
OP[0xC5]=function(){ MEMW(--SP,RB); MEMW(--SP,RC); gbCPUTicks=16; }; // PUSH BC
OP[0xC6]=Function('T1=MEMR(PC++);'+gb_CPU_ADD_A('T1',8)); // ADD A,u8
OP[0xC7]=Function(gb_CPU_RST('0x00')); // RST 0x00
OP[0xC8]=Function(gb_CPU_RET('FZ')); // RET Z
OP[0xC9]=Function(gb_CPU_RET('true')); // RET
OP[0xCA]=Function(gb_CPU_JP('FZ')); // JP Z,u16;
OP[0xCB]=function(){ OPCB[MEMR(PC++)](); };
OP[0xCC]=Function(gb_CPU_CALL('FZ')); // CALL Z,u16
OP[0xCD]=Function(gb_CPU_CALL('true')); // CALL u16
OP[0xCE]=Function('T1=MEMR(PC++);'+gb_CPU_ADC_A('T1',4)); // ADC A,u8;
OP[0xCF]=Function(gb_CPU_RST('0x08')); // RST 0x08
OP[0xD0]=Function(gb_CPU_RET('!FC')); // RET NC
OP[0xD1]=function(){ RE=MEMR(SP++); RD=MEMR(SP++); gbCPUTicks=12; }; // POP DE
OP[0xD2]=Function(gb_CPU_JP('!FC')); // JP NC,u16
OP[0xD3]=gb_CPU_UNK;
OP[0xD4]=Function(gb_CPU_CALL('!FC')); // CALL NC,u16
OP[0xD5]=function(){ MEMW(--SP,RD); MEMW(--SP,RE); gbCPUTicks=16; }; // PUSH DE
OP[0xD6]=Function('T1=MEMR(PC++);'+gb_CPU_SUB_A('T1',8)); // SUB u8
OP[0xD7]=Function(gb_CPU_RST('0x10')); // RST 0x10
OP[0xD8]=Function(gb_CPU_RET('FC')); // RET C
OP[0xD9]=Function(gb_CPU_RET('true')+'gbIME=true;'); // RETI
OP[0xDA]=Function(gb_CPU_JP('FC')); // JP C,u16
OP[0xDB]=gb_CPU_UNK;
OP[0xDC]=Function(gb_CPU_CALL('FC')); // CALL C,u16
OP[0xDD]=gb_CPU_UNK;
OP[0xDE]=Function('T1=MEMR(PC++);'+gb_CPU_SBC_A('T1',8)); // SBC A,u8;
OP[0xDF]=Function(gb_CPU_RST('0x18')); // RST 0x18
...
OP[0xE6]=Function(gb_CPU_AND_A('MEMR(PC++)',8)); // AND u8
OP[0xE7]=Function(gb_CPU_RST('0x20')); // RST 0x20
...
OP[0xEC]=gb_CPU_UNK;
OP[0xED]=gb_CPU_UNK;
OP[0xEE]=Function(gb_CPU_XOR_A('MEMR(PC++)',8)); // XOR u8
OP[0xEF]=Function(gb_CPU_RST('0x28')); // RST 0x28
...
OP[0xF6]=Function(gb_CPU_OR_A('MEMR(PC++)',8)); // OR u8;
OP[0xF7]=Function(gb_CPU_RST('0x30')); // RST 0x30
...
OP[0xFC]=gb_CPU_UNK;
OP[0xFD]=gb_CPU_UNK;
OP[0xFE]=Function('T1=MEMR(PC++);'+gb_CPU_CP_A('T1',8)); // CP u8
OP[0xFF]=Function(gb_CPU_RST('0x38')); // RST 0x38
...
OPCB[0x20]=Function(gb_CPU_SLA_R('RB',8)); // SLA B
OPCB[0x21]=Function(gb_CPU_SLA_R('RC',8)); // SLA C
OPCB[0x22]=Function(gb_CPU_SLA_R('RD',8)); // SLA D
OPCB[0x23]=Function(gb_CPU_SLA_R('RE',8)); // SLA E
OPCB[0x24]=Function('T1=HL>>8;'+gb_CPU_SLA_R('T1',8)+'HL=(T1<<8)|(HL&0x00FF);'); // SLA H
OPCB[0x25]=Function('T1=HL&0xFF;'+gb_CPU_SLA_R('T1',8)+'HL=(HL&0xFF00)|T1;'); // SLA L
OPCB[0x26]=Function('T1=MEMR(HL);'+gb_CPU_SLA_R('T1',16)+'MEMW(HL,T1);'); // SLA (HL)
OPCB[0x27]=Function(gb_CPU_SLA_R('RA',8)); // SLA A
...
OPCB[0x30]=Function(gb_CPU_SWAP('RB'));
OPCB[0x31]=Function(gb_CPU_SWAP('RC'));
OPCB[0x32]=Function(gb_CPU_SWAP('RD'));
OPCB[0x33]=Function(gb_CPU_SWAP('RE'));
OPCB[0x34]=Function(gb_CPU_SWAP('H'));
OPCB[0x35]=Function(gb_CPU_SWAP('L'));
OPCB[0x36]=Function(gb_CPU_SWAP('(HL)'));
OPCB[0x37]=Function(gb_CPU_SWAP('RA'));
...
for (var i=0;i<8;i++) {
  ...
  OPCB[o|7]=Function("FZ=!(RA&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|7]=Function("return 'BIT "+i+",A';");
  OPCB[o|0]=Function("FZ=!(RB&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|0]=Function("return 'BIT "+i+",B';");
  OPCB[o|1]=Function("FZ=!(RC&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|1]=Function("return 'BIT "+i+",C';");
  OPCB[o|2]=Function("FZ=!(RD&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|2]=Function("return 'BIT "+i+",D';");
  OPCB[o|3]=Function("FZ=!(RE&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|3]=Function("return 'BIT "+i+",E';");
  OPCB[o|4]=Function("FZ=!(HL&"+(256<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|4]=Function("return 'BIT "+i+",H';");
  OPCB[o|5]=Function("FZ=!(HL&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=8;");
  MNCB[o|5]=Function("return 'BIT "+i+",L';");
  OPCB[o|6]=Function("FZ=!(MEMR(HL)&"+(1<<i)+");FN=0;FH=1; gbCPUTicks=16;");
  MNCB[o|6]=Function("return 'BIT "+i+",(HL)';");
  // RES n,r - CB 10 xxx xxx - CB 10 bit reg
  o=(2<<6)|(i<<3);
  OPCB[o|7]=Function("RA&="+((~(1<<i))&0xFF)+"; gbCPUTicks=8;");
  MNCB[o|7]=Function("return 'RES "+i+",A';");
  OPCB[o|0]=Function("RB&="+((~(1<<i))&0xFF)+"; gbCPUTicks=8;");
  MNCB[o|0]=Function("return 'RES "+i+",B';");
  OPCB[o|1]=Function("RC&="+((~(1<<i))&0xFF)+"; gbCPUTicks=8;");
  MNCB[o|1]=Function("return 'RES "+i+",C';");
  OPCB[o|2]=Function("RD&="+((~(1<<i))&0xFF)+"; gbCPUTicks=8;");
  MNCB[o|2]=Function("return 'RES "+i+",D';");
  OPCB[o|3]=Function("RE&="+((~(1<<i))&0xFF)+"; gbCPUTicks=8;");
  MNCB[o|3]=Function("return 'RES "+i+",E';");
  OPCB[o|4]=Function("HL&="+((~(256<<i))&0xFFFF)+"; gbCPUTicks=8;");
  MNCB[o|4]=Function("return 'RES "+i+",H';");
  OPCB[o|5]=Function("HL&="+((~(1<<i))&0xFFFF)+"; gbCPUTicks=8;");
  MNCB[o|5]=Function("return 'RES "+i+",L';");
  OPCB[o|6]=Function("MEMW(HL,MEMR(HL)&"+((~(1<<i))&0xFF)+"); gbCPUTicks=16;");
  MNCB[o|6]=Function("return 'RES "+i+",(HL)';");
  // SET n,r - CB 11 xxx xxx - CB 11 bit reg
  o=(3<<6)|(i<<3);
  OPCB[o|7]=Function("RA|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|7]=Function("return 'SET "+i+",A';");
  OPCB[o|0]=Function("RB|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|0]=Function("return 'SET "+i+",B';");
  OPCB[o|1]=Function("RC|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|1]=Function("return 'SET "+i+",C';");
  OPCB[o|2]=Function("RD|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|2]=Function("return 'SET "+i+",D';");
  OPCB[o|3]=Function("RE|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|3]=Function("return 'SET "+i+",E';");
  OPCB[o|4]=Function("HL|="+(256<<i)+"; gbCPUTicks=8;");
  MNCB[o|4]=Function("return 'SET "+i+",H';");
  OPCB[o|5]=Function("HL|="+(1<<i)+"; gbCPUTicks=8;");
  MNCB[o|5]=Function("return 'SET "+i+",L';");
  OPCB[o|6]=Function("MEMW(HL,MEMR(HL)|"+(1<<i)+"); gbCPUTicks=16;");
  MNCB[o|6]=Function("return 'SET "+i+",(HL)';");
}
